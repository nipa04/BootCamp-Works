...
from photogur.views import root, picture_page, picture_show, picture_search, create_comment, login_view, logout_view, signup, new_picture, edit_picture
...
urlpatterns = [
    ...
    path('picture_search', picture_search, name='picture_search'),
